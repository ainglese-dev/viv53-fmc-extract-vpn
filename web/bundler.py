"""Web-adapted CSV bundler — returns CSV bytes instead of writing to disk."""
...
def run_bundler(domain_dir, layout_path):
    """Return (csv_bytes, row_count) from the JSON files in domain_dir."""
    keys, headers = load_layout(layout_path)
